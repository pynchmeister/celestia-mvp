...
func (*Upload) Descriptor() ([]byte, []int) {
	return fileDescriptor_754073a3a2a976dc, []int{0}
}
...
func (m *Upload) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
func (m *Upload) GetContent() string {
	if m != nil {
		return m.Content
	}
	return ""
...
func init() {
	proto.RegisterType((*Upload)(nil), "blog.blog.Upload")
}

func init() { proto.RegisterFile("blog/blog/upload.proto", fileDescriptor_754073a3a2a976dc) }

var fileDescriptor_754073a3a2a976dc = []byte{
	// 168 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x4b, 0xca, 0xc9, 0x4f,
	0xd7, 0x07, 0x13, 0xa5, 0x05, 0x39, 0xf9, 0x89, 0x29, 0x7a, 0x05, 0x45, 0xf9, 0x25, 0xf9, 0x42,
	0x9c, 0x20, 0x21, 0x3d, 0x10, 0xa1, 0x94, 0xc4, 0xc5, 0x16, 0x0a, 0x96, 0x12, 0x92, 0xe0, 0x62,
	...
	0x84, 0x44, 0xb8, 0x58, 0x4b, 0x32, 0x4b, 0x72, 0x52, 0x25, 0x98, 0xc1, 0xea, 0x20, 0x1c, 0xb0,
	0xfe, 0xfc, 0xbc, 0x92, 0xd4, 0xbc, 0x12, 0x09, 0x16, 0xa8, 0x7e, 0x08, 0xd7, 0x49, 0xfb, 0xc4,
	0x23, 0x39, 0xc6, 0x0b, 0x8f, 0xe4, 0x18, 0x1f, 0x3c, 0x92, 0x63, 0x9c, 0xf0, 0x58, 0x8e, 0xe1,
	0xc2, 0x63, 0x39, 0x86, 0x1b, 0x8f, 0xe5, 0x18, 0xa2, 0x04, 0xc1, 0x6e, 0xab, 0x80, 0x38, 0xb1,
	0xa4, 0xb2, 0x20, 0xb5, 0x38, 0x89, 0x0d, 0xec, 0x44, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff,
	0xe1, 0x02, 0xba, 0x8a, 0xbc, 0x00, 0x00, 0x00,
}

func (m *Upload) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *Upload) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Upload) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Content) > 0 {
		...
		i = encodeVarintUpload(dAtA, i, uint64(len(m.Content)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Title) > 0 {
		i -= len(m.Title)
		copy(dAtA[i:], m.Title)
		i = encodeVarintUpload(dAtA, i, uint64(len(m.Title)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Id != 0 {
		i = encodeVarintUpload(dAtA, i, uint64(m.Id))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Creator) > 0 {
		...
		i = encodeVarintUpload(dAtA, i, uint64(len(m.Creator)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *Upload) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
